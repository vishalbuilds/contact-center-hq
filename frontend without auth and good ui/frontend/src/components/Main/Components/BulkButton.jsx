...
const MODES = [
  {
    ...
    label: "Get Data",
    icon: "↓",
    desc: "Fetch records by queue / record name",
  },
  {
    id: "create",
    label: "Bulk Create",
    icon: "+",
    desc: "Create new records — fails if already exists",
  },
  {
    id: "update",
    label: "Bulk Update",
    icon: "↻",
    desc: "Update existing records — fails if not found",
  },
];

export default function BulkButton({ onOpenModal }) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 bg-white border border-[#d4c4d4] rounded-xl shadow-lg z-20 py-1 w-52 overflow-hidden">
